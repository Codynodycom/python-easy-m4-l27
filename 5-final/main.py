...
from file_manager import show_score, update_score_file
...
if nikname_1.lower() in winner.lower():
    # сохраняем результаты
    update_score_file(
        current_name=nikname_1.lower(),
        score=1
    )
elif nikname_2.lower() in winner.lower():
    # сохраняем результаты
    update_score_file(
        current_name=nikname_2.lower(),
        score=1
    )
